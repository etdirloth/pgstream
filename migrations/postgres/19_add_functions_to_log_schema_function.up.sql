...
-- Add functions and procedures to log_schema function
...
BEGIN
    ...
    IF tg_event = 'sql_drop' THEN
        IF tg_tag = 'DROP SCHEMA' THEN
            ...
            END IF;
        ELSIF tg_tag IN ('DROP TABLE', 'DROP INDEX', 'DROP MATERIALIZED VIEW', 'DROP SEQUENCE'
    ...
    ELSIF tg_event = 'ddl_command_end' THEN
        IF tg_tag = 'CREATE SCHEMA' THEN
            ...
            LIMIT 1;
        ELSIF tg_tag IN ('CREATE TABLE', 'ALTER TABLE', 'CREATE INDEX', 'CREATE UNIQUE INDEX', 'ALTER INDEX', 'SELECT INTO', 'CREATE TABLE AS', 'CREATE MATERIALIZED VIEW', 'ALTER MATERIALIZED VIEW', 'CREATE SEQUENCE', 'ALTER SEQUENCE',
